##R function to prompt user to select proper workflow and workflow version 
...
#this works, but will require that the user know which workflow and workflow version they desire.